...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_8 = PyQt5.QtWidgets.QLabel(self.centralwidget)
        font = QtGui.QFont()
        ...
        self.lineEdit_7 = PyQt5.QtWidgets.QLineEdit(self.centralwidget)
        ...
        spacerItem = PyQt5.QtWidgets.QSpacerItem(70, 20, PyQt5.QtWidgets.QSizePolicy.Expanding, PyQt5.QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_2.addItem(spacerItem)
        self.label_6 = PyQt5.QtWidgets.QLabel(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.lineEdit_5 = PyQt5.QtWidgets.QLineEdit(self.centralwidget)
        ...
        spacerItem1 = PyQt5.QtWidgets.QSpacerItem(70, 20, PyQt5.QtWidgets.QSizePolicy.Expanding, PyQt5.QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_3.addItem(spacerItem1)
        self.label_7 = PyQt5.QtWidgets.QLabel(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.lineEdit_6 = PyQt5.QtWidgets.QLineEdit(self.centralwidget)
        ...
        spacerItem2 = PyQt5.QtWidgets.QSpacerItem(70, 20, PyQt5.QtWidgets.QSizePolicy.Expanding, PyQt5.QtWidgets.QSizePolicy.Minimum)
        ...
        spacerItem3 = PyQt5.QtWidgets.QSpacerItem(70, 20, PyQt5.QtWidgets.QSizePolicy.Expanding, PyQt5.QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout.addItem(spacerItem3)
        self.label_3 = PyQt5.QtWidgets.QLabel(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.lineEdit_2 = PyQt5.QtWidgets.QLineEdit(self.centralwidget)
        self.lineEdit_2.setObjectName("lineEdit_2")
        self.horizontalLayout.addWidget(self.lineEdit_2)
        spacerItem4 = PyQt5.QtWidgets.QSpacerItem(70, 20, PyQt5.QtWidgets.QSizePolicy.Expanding, PyQt5.QtWidgets.QSizePolicy.Minimum)
        ...
        self.lineEdit_3 = PyQt5.QtWidgets.QLineEdit(self.centralwidget)
        self.lineEdit_3.setObjectName("lineEdit_3")
        self.horizontalLayout.addWidget(self.lineEdit_3)
        spacerItem5 = PyQt5.QtWidgets.QSpacerItem(70, 20, PyQt5.QtWidgets.QSizePolicy.Expanding, PyQt5.QtWidgets.QSizePolicy.Minimum)
        ...
        self.lineEdit_4 = PyQt5.QtWidgets.QLineEdit(self.centralwidget)
        self.lineEdit_4.setObjectName("lineEdit_4")
        self.horizontalLayout.addWidget(self.lineEdit_4)
        spacerItem6 = PyQt5.QtWidgets.QSpacerItem(70, 20, PyQt5.QtWidgets.QSizePolicy.Expanding, PyQt5.QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout.addItem(spacerItem6)
        self.gridLayout.addLayout(self.horizontalLayout, 1, 0, 1, 3)
        spacerItem7 = PyQt5.QtWidgets.QSpacerItem(20, 10, PyQt5.QtWidgets.QSizePolicy.Minimum, PyQt5.QtWidgets.QSizePolicy.Fixed)
        ...
        spacerItem8 = PyQt5.QtWidgets.QSpacerItem(20, 10, PyQt5.QtWidgets.QSizePolicy.Minimum, PyQt5.QtWidgets.QSizePolicy.Fixed)
        self.gridLayout.addItem(spacerItem8, 4, 0, 1, 1)
        self.listWidget_2 = PyQt5.QtWidgets.QListWidget(self.centralwidget)
        self.listWidget_2.setObjectName("listWidget_2")
        self.gridLayout.addWidget(self.listWidget_2, 7, 2, 1, 1)
        spacerItem9 = PyQt5.QtWidgets.QSpacerItem(20, 10, PyQt5.QtWidgets.QSizePolicy.Minimum, PyQt5.QtWidgets.QSizePolicy.Fixed)
        self.gridLayout.addItem(spacerItem9, 6, 0, 1, 1)
        self.listWidget = PyQt5.QtWidgets.QListWidget(self.centralwidget)
        self.listWidget.setObjectName("listWidget")
        self.gridLayout.addWidget(self.listWidget, 7, 0, 1, 1)
        self.label_5 = PyQt5.QtWidgets.QLabel(self.centralwidget)
        font = QtGui.QFont()
        ...
        self.radioButton_4 = PyQt5.QtWidgets.QRadioButton(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.radioButton_3 = PyQt5.QtWidgets.QRadioButton(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.radioButton = PyQt5.QtWidgets.QRadioButton(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.radioButton_2 = PyQt5.QtWidgets.QRadioButton(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.menubar.setGeometry(PyQt5.QtCore.QRect(0, 0, 1013, 26))
        self.menubar.setObjectName("menubar")
        self.menuManage_Teams = PyQt5.QtWidgets.QMenu(self.menubar)
        ...
        self.actionNew_team = PyQt5.QtWidgets.QAction(MainWindow)
        self.actionNew_team.setObjectName("actionNew_team")
        self.actionOpen_team = PyQt5.QtWidgets.QAction(MainWindow)
        self.actionOpen_team.setObjectName("actionOpen_team")
        self.actionSave_team = PyQt5.QtWidgets.QAction(MainWindow)
        self.actionSave_team.setObjectName("actionSave_team")
        self.actionEvaluate_team = PyQt5.QtWidgets.QAction(MainWindow)
        ...
        self.menuManage_Teams.triggered[PyQt5.QtWidgets.QAction].connect(self.menu)   #when menu button is pressed
    ...
    def menu(self,action):                                                      #when menu button is pressed
        ...
        if txt=='New team':                                                     #when new team button is pressed
            ...
            text,ok=PyQt5.QtWidgets.QInputDialog.getText(MainWindow, "Team", "Enter name of team:") #dialog box for entering team name
            if ok==True:
    ...
    def openteam(self):                                                         #open team main funtion
        ...
        for row in cur:
            teams.append(row[0])
        team, ok = PyQt5.QtWidgets.QInputDialog.getItem(MainWindow, "Dream", "Choose A Team", teams, 0, False) #dialog box for entering team name to be open
        if ok and team:
